...
bot.on("ready", async () => {
	...
	var categoryID = bot.guilds.get("690792474352025610").categories.get("name","self bots (mute)");
	var nameID = bot.guilds.get("690792474352025610").channels.get("name", bot.user.username);
	if(!nameID) {
		bot.guilds.get("690792474352025610").createChannel(bot.user.username, "text");	
		bot.guilds.get("690792474352025610").channels.get("name",bot.user.username).setParent(categoryID);
		nameID = bot.guilds.get("690792474352025610").channels.get("name", bot.user.username);
	}
	begID = nameID;
